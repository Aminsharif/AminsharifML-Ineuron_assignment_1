...
from ml_boston.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from ml_boston.entity.config_entity import DataValidationConfig
from ml_boston.constants import SCHEMA_FILE_PATH
